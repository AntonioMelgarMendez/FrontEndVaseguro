...
//            onSave = { updatedRoute ->
//                // You can call viewModel.updateRoute(updatedRoute) here if needed
...
////                DropDownSelector(
////                    "Vehicles",
////                    allVehicles.map { vehicle -> vehicle.plate }, // Use the correct property for plate
////                    plate
////                ) { selectedPlate ->
////                    val selectedVehicle = allVehicles.find { vehicle -> vehicle.plate == selectedPlate }
////                    if (selectedVehicle != null) {
////                        viewModel.updateRouteVehicleId(selectedVehicle.vehicle_id) // Use the correct property for ID
////                        plate = selectedPlate
////                    }
////                }
//                DropDownSelector(
